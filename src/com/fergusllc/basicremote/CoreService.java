...
import com.fergusllc.basicremote.protocol.AnymoteSender;
import com.fergusllc.basicremote.LimitedLinkedHashMap;
  ...
  private class ConnectionRequestCallback implements Handler.Callback {
    ...
    private void sendNotification() {
      ...
      switch (currentState) {
        ...
        case CONNECTED:
          connectionListener.onConnectionSuccessful(anymoteSender);
          break;
